...
if(isset($_POST["btnthem"])){
	...
	$id= mysqli_query($conn,"
        SELECT MAX(MADANHMUC)
        FROM danhmuc;
    ");
   	 	$idmoi= $id-> fetch_assoc();
    	$idmoi1 = $idmoi["MAX(MADANHMUC)"];
		$idmoi1++;
		$linkanh = 'assets/img/categories/'.$linkanh;

	mysqli_query($conn,"
            insert into danhmuc (MADANHMUC ,TENDANHMUC,ANHDANHMUC)
            values ('$idmoi1','$tendanhmuc','$linkanh')
        ");
						...
						<div class="card">
							<div class="card-body">
								...
								<form action="" method="post">
                                    ...
                                    <div class="mt-4">
										<button class="btn btn-primary" type="submit" name = "btnthem">Thêm</button>
