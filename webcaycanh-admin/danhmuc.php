				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-auto text-right">
							...
							<a href="themdanhmuc.php" class="btn btn-primary add-button ml-3">
										...
										<tbody>
                                                ...
                                                <?php 
                                                     ...
                                                     while($row = $result->fetch_assoc()) {
                                                         $imagePath = $row['ANHDANHMUC'];
                                                         $madanhmuc =  $row['MADANHMUC'] ;
                                                         $tendanhmuc =  $row['TENDANHMUC'] ;
													?>
                                                         <tr>

                                                         <td><?php echo "$madanhmuc" ?></td>
                                                         <td>
                                                             <img class='rounded service-img mr-1' src=" <?php echo $imagePath;?>" alt='Hình ảnh danh mục'><?php echo "$tendanhmuc" ?></td>
                                                         <td>
                                                         ...
                                                         <td class='text-right'>
														 <form  method="get" action="xoadanhmuc.php">
														 <input type = "hidden" value = " <?php echo $tendanhmuc; ?>" name = "tendanhmuc" >
														 <input type = "hidden" value = " <?php echo $madanhmuc; ?>" name = "id" >
														 <a> <i class="fa fa-trash-o"></i> <input type = "submit" value = "Xóa" name = "btnxoa" class="btn btn-outline-danger btn-sm"></a>
														 </form>

														 <form  method="get" action="suadanhmuc.php">
														 <input type = "hidden" value = " <?php echo $tendanhmuc; ?>" name = "tendanhmuc" >
														 <input type = "hidden" value = " <?php echo $madanhmuc; ?>" name = "id" >
