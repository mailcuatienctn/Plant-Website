...
if(isset($_POST["btnluu"])){
	...
	$linkanh = 'assets/img/categories/'.$linkanh;
	...
	select MADANHMUC from danhmuc where TENDANHMUC = '$tendanhmuc' ");
	$rows= $rows-> fetch_assoc();
	$iddanhmuc = $rows["MADANHMUC"];
	// var_dump($iddanhmuc);

	$rows = mysqli_query($conn,"
	select MANCC from nhacuncap where TENNCC = '$tennhacungcap' ");
	$rows = $rows-> fetch_assoc();
	$idncc = $rows["MANCC"];
	// var_dump($idncc);

	$idsanpham =(int) $_GET['masanpham'];

	mysqli_query($conn,"
    UPDATE sanpham
    SET MADANHMUC = '$iddanhmuc', TENSANPHAM = '$tenmoi', ANHSANPHAM = '$linkanh', MOTASANPHAM = '$mota'
	, GIABAN = '$giaban', SOLUONG = '$soluong', GIANHAP = '$gianhap', MANCC = '$idncc'
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="dashboard.php"><i class="fas fa-columns"></i> <span>Dashboard</span></a>
                        </li>
                        <li class="submenu">
                            <a href="#"><i class="fas fa-tasks"></i> <span>Quản lí</span> <span class="menu-arrow"></span></a>
                            <ul style="display: none;">
                                <li><a href="danhmuc.php">Danh mục</a></li>
                                <li><a href="quanlysanpham.php" class="active">Sản phẩm</a></li>
						...
						<div class="card">
							<div class="card-body">
								<div class="table-responsive">
									...
									<label><br>Tên sản phẩm</label>
									<input class='form-control' value = '$tensanpham' required>
								</div>";
										?>
									</div>
                                    ...
                                    <div class="form-group">
										<label><br>Tên sản phẩm mới</label>
										<input class="form-control" type="text" name = "tenmoi" required>
									</div>
									<input type="" class = "hidden-element">
									<div class="form-group">
										<label><br><b>Chọn ảnh muốn đổi </b></label>
                                    ...
                                    <div class="form-group">
										...
										<input class="form-control" type="text" value="" name = "gianhap">
                                    </div>

									<div class="form-group">
										<label><br>Giá bán</label>
										<input class="form-control" type="text" value="" name = "giaban">
                                    </div>
                                    ...
                                    <div class="form-group">
										<label><br>Mô tả</label>
                                        <textarea style="height: 100px;" class="form-control" type="text" name = "mota"></textarea>
									</div>
									
									<div class="mt-4">
										<button class="btn btn-primary" type="submit" name = "btnluu">Lưu</button>
										<a href="suasanpham.php" class="btn btn-link">Hủy</a>
									</div>
