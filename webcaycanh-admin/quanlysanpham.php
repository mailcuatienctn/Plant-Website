                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
								...
								<li><a href="danhsachadmin.php">Danh sách admin</a></li>
				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-auto text-right">
							...
							<a href="themsanpham.php" class="btn btn-primary add-button ml-3">
									...
									<table class="table table-hover table-center mb-0 datatable">
                                        ...
                                        <tr>
                                                ...
                                                while($row = $result->fetch_assoc()) {
                                                    ...
                                                    select TENDANHMUC from danhmuc where MADANHMUC = '$madanhmuc' ");
                                                    $tendanhmuc= $rows-> fetch_assoc();
    	                                            $tendanhmuc = $tendanhmuc["TENDANHMUC"];

                                                    $rows = mysqli_query($conn,"
                                                    select TENNCC from nhacuncap where MANCC = '$mancc' ");
                                                    $tenncc= $rows-> fetch_assoc();
    	                                            $tenncc = $tenncc["TENNCC"];
?>
                                                
                                                <tr>
                                                    <td><?php echo $masanpham ?></td>
                                                    <td> <img class='rounded service-img mr-1' src='<?php echo $imagePath ?>' alt='Hình ảnh danh mục'></td>
													<td><?php echo $tensanpham ?></td>
													<td><?php echo $tendanhmuc ?></td>
													<td><?php echo number_format($gianhap).' VNĐ' ?></td>
													<td><?php echo $ngaynhap ?></td>
													<td><?php echo number_format($giaban).' VNĐ' ?></td>
													<td><?php echo $soluong?></td>
													<td><?php echo $tenncc ?></td>
												<td class='text-right'>
												<form  method="get" action="xoasanpham.php">
														 <input type = "hidden" value = " <?php echo $tensanpham; ?>" name = "tensanpham" >
														 <input type = "hidden" value = " <?php echo $masanpham; ?>" name = "masanpham" >
														 <a> <i class="fa fa-trash-o"></i> <input type = "submit" value = "Xóa" name = "btnxoa" class="btn btn-outline-danger btn-sm"></a>
														 </form>

														 <form  method="get" action="suasanpham.php">
														 <input type = "hidden" value = " <?php echo $tensanpham; ?>" name = "tensanpham" >
														 <input type = "hidden" value = " <?php echo $masanpham; ?>" name = "masanpham" >
														 <a> <i class="far fa-edit mr-1"></i><input type = "submit" value = "Sửa" name = "btnxoa" class="btn btn-sm bg-success-light btn-sm" ></a>
														 </form>
												</td>
                                                </tr>
                                                <?php }; ?>
