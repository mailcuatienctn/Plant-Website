...
$tableid = mysqli_query($conn,"
select * from user where USERID = '$iduser'
");
$tableid = $tableid->fetch_assoc();
$ten = $tableid['FULLNAME'];
$diachi = $tableid['DIACHIUS'];
$sdt = $tableid['PHONEUS'];

$iddonhang = (int) $_GET['madonhang'];
...
if($iddonhang == 0){
    ...
    $iddonhang = mysqli_query($conn,"
    SELECT MADONHANG
    FROM donhang WHERE MADONHANG = '$iddonhang';
    ");
    
$iddonhang = $iddonhang -> fetch_assoc();
$iddonhang = $iddonhang["MADONHANG"];
    // var_dump($iddonhang);
...
$magiamgia = mysqli_query($conn,"
SELECT * FROM donhang WHERE MADONHANG = '$iddonhang';
");
$magiamgia = $magiamgia -> fetch_assoc();
$magiamgia = $magiamgia["MAGIAMGIA"];

$sql = "SELECT * FROM chitietdonhang WHERE MADONHANG = '$iddonhang'"; 
                ...
                <div class="col-lg-6">
                    <nav class="header__menu">
                        ...
                        <li class="active"><a href="index.php">Trang Chủ</a></li>
                            <li><a href="muahang.php">Mua sắm</a></li>
                            <li><a href="./contact.html">Liên hệ</a></li>
                            ...
                            <div class="styles_section-2">
                                <div class="styles_group_1">
                                    <div class="title">Địa chỉ người nhận</div><div class="content">
                                        <p class="name"><?php echo $ten; ?></p><p class="address">
                                            <span>Địa chỉ: </span><?php echo $diachi; ?></p>
                                            <p class="phone">
                                                <span>Điện thoại: </span><?php echo $sdt; ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="styles_group_1">
                            ...
                            <table class="styles_section-3">
                                    ...
                                    <tbody>
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                $idsanpham = $row['MASANPHAM'];
                                                $soluong =  $row['SOLUONG'];
                                                $listsanpham = mysqli_query($conn,"
                                            SELECT *
                                            FROM sanpham WHERE MASANPHAM = '$idsanpham';
                                            ");
                                            $listsanpham = $listsanpham -> fetch_assoc();
                                            $tensanpham = $listsanpham["TENSANPHAM"];
                                            $giasanpham = $listsanpham["GIABAN"];
                                            $anhsanpham = $listsanpham["ANHSANPHAM"];

                                            $giamgia = (($giasanpham * $soluong) * $magiamgia) / 100;
                                            $tonggiamgia = ($giasanpham * $soluong) - $giamgia;
                                                ...
                                                // var_dump($magiamgia);
                                                // var_dump($giamgia);
                                                // var_dump($tonggiamgia);
                                            $tongcong = $tongcong + $tonggiamgia;
                                        ...
                                        <tr>
                                            <td>
                                                <div class="product-item">
                                                    <img src="<?php echo $anhsanpham; ?>" alt="Cây Cẩm Nhung chống bức xạ điện thoại">
                                                    <div class="product-info">
                                                        <a class="product-name" href="#"><?php echo $tensanpham; ?></a>
                                                        <p class="product-seller">Cung cấp bởi Thế Giới Cây Cảnh</p>
                                                        <div class="product-review">
                                                            <a href="#" target="_blank">Viết nhận xét</a>
                                                            <a href="#" target="_blank">Mua lại</a>
                                                            <button disabled>Hủy Đơn Hàng</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="price"><?php echo $giasanpham; ?></td>
                                            <td class="quantity"><?php echo $soluong; ?></td>
                                            <td class="discount-amount"><?php echo $giamgia; ?></td>
                                            <td class="raw-total"><?php echo number_format($tonggiamgia)." VNĐ"; ?></td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tfoot>
                                        ...
                                        <td>
                                            <span class="sum"><?php echo number_format($tongcong)." VNĐ";?></span>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                            <a class="view-list-order" href="donhang.php">Quay lại đơn hàng của tôi</a>
