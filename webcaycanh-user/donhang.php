...
$sql = "SELECT * FROM donhang WHERE USERID = '$iduser'"; 
                        ...
                        <div class="inner">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <input type = "hidden" value = " <?php echo $madonhang ?>" name = "madonhang" >

                                    <td><button class="btn btn-primary" type="submit" name = "btnthem"><?php echo $madonhang; ?></button> </td>                                       
                                    </form>
